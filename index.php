    ...
    <body>
        ...
        <div id="main-container" class="container-fluid">
            ...
            <div class="row bordered" id="header-row">
                <div class="hidden-xs col-sm-2 blue bordered">
                </div>
                <div class="col-xs-12 col-sm-8 bordered">
                ...
                <div class="hidden-xs col-sm-2 bordered"></div>
            </div>
            ...
            <div class="row full-container">
                ...
                <!-- Main Content -->
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 bordered" style="min-height: 400px;">

                    <div class="row bordered">
                        <div id="nav-menu" class="col-xs-12 yellow">
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                <li role="presentation" class="active"><a href="#sentia" aria-controls="sentia" role="tab" data-toggle="tab">Sentia</a></li>
                                <li role="presentation"><a href="#staff" aria-controls="presentations" role="tab" data-toggle="tab">Starfsfólk</a></li>                              
                                <li role="presentation"><a href="#presentations" aria-controls="presentations" role="tab" data-toggle="tab">Fyrirlestrar</a></li>
                                <li role="presentation"><a href="#workshops" aria-controls="workshops" role="tab" data-toggle="tab">Námskeið</a></li>
                                <li role="presentation"><a href="#edu-material" aria-controls="edu-material" role="tab" data-toggle="tab">Fræðsluefni</a></li>
                            </ul>
                        </div>
                    </div>                    
                    ...
                    <div id="main-content" class="row bordered">
                        <div class="col-xs-12">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="sentia">
                                    <h2>Sentia Sálfræðistofa</h1>
                                        ...
                                        <h2>Viðtalsmeðferð</h2>
                                        <li>Einstaklingsviðtöl fyrir börn, unglinga og foreldra</li>
                                        <li>Handleiðsla og ráðgjöf fyrir foreldra</li>
                                        <li>Fjölskyldumeðferð</li>
                                        <li>Skype viðtöl</li>

                                        <h2>Sálfræðiathugun</h2>
                                        <li>Skimun á þroska, hegðun og líðan</li>
                                        <li>Greining og vitsmunaþroskamat</li>
                                        <li>Tilvísanir í önnur úrræði eftir sem á við</li>
                                        <li>Forsjár- og umgengnimál</li>

                                        <h2>Önnur þjónusta</h2>
                                        <li>Fyrirlestrar</li>
                                        <li>Námskeið</li>
                                        <li>Fundir í skóla</li>
                                        <li>Fundir með skjólstæðingum, foreldrum og öðrum fagaðilum</li>


                                        <div style="margin-top: 30px;">
                                            <iframe width="100%" height="200" frameborder="0" src="http://ja.is/kort/embedded/?zoom=8&x=363117&y=405527&layer=map&q=Sentia+S%C3%A1lfr%C3%A6%C3%B0istofa%2C+H%C3%B6f%C3%B0abakka+9+3.+h%C3%A6%C3%B0"></iframe>                                    
                                        </div>

                                </div>


                                <div role="tabpanel" class="tab-pane fade" id="presentations">
                                    <h1>Fyrirlestrar</h1>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="staff">
                                    <h1>Starfsfólk Sentia</h1>                                    

                                    <div class="row">
                                        <div class="col-xs-4 col-md-3">                                            
                                            <img src="content/images/staff/soffiaelin.jpg" />
                                        </div>
                                        <div class="col-xs-8 col-md-9">
                                            <h2>Soffía Elín Sigurðardóttir</h2>
                                            <p>Soffía er blablabla..</p>
                                            <p><button class="btn btn-link" onclick="$('#staff-1').modal('show');">Sjá meira</button></p>
                                        </div>
                                    </div>
                                    <br/>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4 col-md-3">                                            
                                            <img src="content/images/staff/elinanna.jpg" />
                                        </div>
                                        <div class="col-xs-8 col-md-9">
                                            <h2>Elín Anna Baldursdóttir</h2>
                                            <p>Elín er blablabla..</p>
                                            <p><button class="btn btn-link" onclick="$('#staff-2').modal('show');">Sjá meira</button></p>
                                        </div>
                                    </div>
                                    <br/>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4 col-md-3">                                            
                                            <img src="content/images/staff/hannadorothea.jpg" />
                                        </div>
                                        <div class="col-xs-8 col-md-9">
                                            <h2>Hanna Dorothéa Bizouerne</h2>
                                            <p>Hanna er blablabla..</p>
                                            <p><button class="btn btn-link" onclick="$('#staff-3').modal('show');">Sjá meira</button></p>
                                        </div>
                                    </div>                                    
                                </div>
                ...
                <div class="hidden-xs col-sm-2 col-sm-offset-10 full" style="color: white">

                    <div class="row bordered">
                        <div class="col-xs-12 bordered full" style="background-color: #EEE; min-height: 300px;"></div>
                    </div>
                    <div class="row bordered full-container" style="height: calc(100% - 306px);">
                        <div class="col-xs-12 bordered full red ">
        ...
        <div class="modal fade" id="staff-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <img src="content/images/staff/soffiaelin.jpg" />
                        <h3 style="margin-top: 20px;">Soffía Elín Sigurðardóttir <small>Sálfræðingur</small></h3>
                        <p class="text-muted">
        ...
        <div class="modal fade" id="staff-2">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <img src="content/images/staff/elinanna.jpg" />
                        <h3 style="margin-top: 20px;">Elín Anna Baldursdóttir <small>Sálfræðingur</small></h3>
                        <p class="text-muted">
                            <span class="glyphicon glyphicon-envelope"></span> Netfang: 
        ...
        <div class="modal fade" id="staff-3">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <img src="content/images/staff/hannadorothea.jpg" />
                        <h3 style="margin-top: 20px;">Hanna Dorothéa Biziouerne <small>Sálfræðingur</small></h3>
                        <p class="text-muted">
                            <span class="glyphicon glyphicon-envelope"></span> Netfang: 
